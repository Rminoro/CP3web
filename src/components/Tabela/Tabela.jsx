...
//         const response = await fetch("http://localhost:3000/api/laticinios/[id]", {
//           method: "POST",
//           headers: {
...
//     fetchData();
//   }, []);
//         // ... (verificações e uso da variável data)
  ...
  const fetchData = async () => {
    try {
      ...
      if (Array.isArray(data)) {
        ...
        // Se o retorno for um objeto, criamos uma matriz com esse objeto
        setQueijos([data]);
      } else {
        console.error("Erro: Os dados não estão no formato esperado.");
      }
